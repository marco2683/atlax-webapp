...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  document.getElementById('card-select-table')?.addEventListener('click', openTabularView);
  document.getElementById('card-select-globe')?.addEventListener('click', openGlobeView);
